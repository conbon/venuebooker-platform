...
class ListSearchInput extends Component {
  render() {
    return (<div className="listsearch-input-wrap fl-wrap">
      ...
      <div className="listsearch-input-item">
        <select data-placeholder="Location" className="chosen-select">
          <option>
            All Locations
          </option>
          <option>
      ...
      <div className="listsearch-input-text">
        ...
        <input type="text" placeholder="Destination , Area , Street" className="qodef-archive-places-search" value=""/>
